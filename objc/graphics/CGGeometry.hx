...
/* The "zero" point -- equivalent to CGPointMake(0, 0). */ 
	...
	@:nativeImpl @:c public static var CGPointZero :CGPoint;

/* The "zero" size -- equivalent to CGSizeMake(0, 0). */ 

	@:nativeImpl @:c public static var CGSizeZero :CGSize;

/* The "zero" rectangle -- equivalent to CGRectMake(0, 0, 0, 0). */ 

	@:nativeImpl @:c public static var CGRectZero :CGRect;
...
/* The "empty" rect. This is the rectangle returned when, for example, we
   ...
   same as the zero rect. */
	...
	@:nativeImpl @:c public static var CGRectNull :CGRect;

/* The infinite rectangle. */

	@:nativeImpl @:c public static var CGRectInfinite :CGRect;

/* Make a point from `(x, y)'. */

	@:nativeImpl @:c public static function CGPointMake(x:Float, y:Float) :CGPoint;

/* Make a size from `(width, height)'. */

	@:nativeImpl @:c public static function CGSizeMake(width:Float, height:Float) :CGSize;

/* Make a rect from `(x, y; width, height)'. */

	@:nativeImpl @:c public static function CGRectMake(x:Float, y:Float, width:Float, height:Float) :CGRect;

/* Return the leftmost x-value of `rect'. */

	@:nativeImpl @:c public static function CGRectGetMinX(rect:CGRect) :Float;

/* Return the midpoint x-value of `rect'. */

	@:nativeImpl @:c public static function CGRectGetMidX(rect:CGRect) :Float;

/* Return the rightmost x-value of `rect'. */

	@:nativeImpl @:c public static function CGRectGetMaxX(rect:CGRect) :Float;

/* Return the bottommost y-value of `rect'. */

	@:nativeImpl @:c public static function CGRectGetMinY(rect:CGRect) :Float;

/* Return the midpoint y-value of `rect'. */

	@:nativeImpl @:c public static function CGRectGetMidY(rect:CGRect) :Float;

/* Return the topmost y-value of `rect'. */

	@:nativeImpl @:c public static function CGRectGetMaxY(rect:CGRect) :Float;

/* Return the width of `rect'. */

	@:nativeImpl @:c public static function CGRectGetWidth(rect:CGRect) :Float;

/* Return the height of `rect'. */

	@:nativeImpl @:c public static function CGRectGetHeight(rect:CGRect) :Float;

/* Return true if `point1' and `point2' are the same, false otherwise. */

	@:nativeImpl @:c public static function CGPointEqualToPoint(point1:CGPoint, point2:CGPoint) :Bool;

/* Return true if `size1' and `size2' are the same, false otherwise. */

	@:nativeImpl @:c public static function CGSizeEqualToSize(size1:CGSize, size2:CGSize) :Bool;

/* Return true if `rect1' and `rect2' are the same, false otherwise. */

	@:nativeImpl @:c public static function CGRectEqualToRect(rect1:CGRect, rect2:CGRect) :Bool;

/* Standardize `rect' -- i.e., convert it to an equivalent rect which has
   positive width and height. */

	@:nativeImpl @:c public static function CGRectStandardize(rect:CGRect) :CGRect;

/* Return true if `rect' is empty (that is, if it has zero width or height),
   false otherwise. A null rect is defined to be empty. */

	@:nativeImpl @:c public static function CGRectIsEmpty(rect:CGRect) :Bool;

/* Return true if `rect' is the null rectangle, false otherwise. */

	@:nativeImpl @:c public static function CGRectIsNull(rect:CGRect) :Bool;

/* Return true if `rect' is the infinite rectangle, false otherwise. */

	@:nativeImpl @:c public static function CGRectIsInfinite(rect:CGRect) :Bool;

/* Inset `rect' by `(dx, dy)' -- i.e., offset its origin by `(dx, dy)', and
   decrease its size by `(2*dx, 2*dy)'. */

	@:nativeImpl @:c public static function CGRectInset(rect:CGRect, dx:Float, dy:Float) :CGRect;

/* Expand `rect' to the smallest rect containing it with integral origin and
   size. */

	@:nativeImpl @:c public static function CGRectIntegral(rect:CGRect) :CGRect;

/* Return the union of `r1' and `r2'. */

	@:nativeImpl @:c public static function CGRectUnion(r1:CGRect, r2:CGRect) :CGRect;

/* Return the intersection of `r1' and `r2'. This may return a null rect. */

	@:nativeImpl @:c public static function CGRectIntersection(r1:CGRect, r2:CGRect) :CGRect;

/* Offset `rect' by `(dx, dy)'. */

	@:nativeImpl @:c public static function CGRectOffset(rect:CGRect, dx:Float, dy:Float) :CGRect;
...
/* Return true if `point' is contained in `rect', false otherwise. */
	...
	@:nativeImpl @:c public static function CGRectContainsPoint(rect:CGRect, point:CGPoint) :Bool;
...
/* Return true if `rect2' is contained in `rect1', false otherwise. `rect2'
   ...
   `rect1'. */
	...
	@:nativeImpl @:c public static function CGRectContainsRect(rect1:CGRect, rect2:CGRect) :Bool;
...
/* Return true if `rect1' intersects `rect2', false otherwise. `rect1'
   ...
   null rect. */
	...
	@:nativeImpl @:c public static function CGRectIntersectsRect(rect1:CGRect, rect2:CGRect) :Bool;
