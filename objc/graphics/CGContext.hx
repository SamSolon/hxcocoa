...
/* Push a copy of the current graphics state onto the graphics state stack.
   ...
   not saved. */
	...
	@:nativeImpl @:c public static function CGContextSaveGState (c:CGContextRef) :Void;

/* Restore the current graphics state from the one on the top of the
   graphics state stack, popping the graphics state stack in the process. */

	@:nativeImpl @:c public static function CGContextRestoreGState(c:CGContextRef) :Void;
...
/* Scale the current graphics state's transformation matrix (the CTM) by
   `(sx, sy)'. */
	...
	@:nativeImpl @:c public static function CGContextScaleCTM(c:CGContextRef, sx:Float, sy:Float) :Void;

/* Translate the current graphics state's transformation matrix (the CTM) by
   `(tx, ty)'. */

	@:nativeImpl @:c public static function CGContextTranslateCTM(c:CGContextRef, tx:Float, ty:Float) :Void;

/* Rotate the current graphics state's transformation matrix (the CTM) by
   `angle' radians. */

	@:nativeImpl @:c public static function CGContextRotateCTM(c:CGContextRef, angle:Float) :Void;

/* Concatenate the current graphics state's transformation matrix (the CTM)
   with the affine transform `transform'. */

	@:nativeImpl @:c public static function CGContextConcatCTM(c:CGContextRef, transform:CGAffineTransform) :Void;

/* Return the current graphics state's transformation matrix. */

	@:nativeImpl @:c public static function CGContextGetCTM(c:CGContextRef) :CGAffineTransform;

/** Drawing attribute functions. **/

/* Set the line width in the current graphics state to `width'. */

	@:nativeImpl @:c public static function CGContextSetLineWidth(c:CGContextRef, width:Float) :Void;

/* Set the line cap in the current graphics state to `cap'. */

	@:nativeImpl @:c public static function CGContextSetLineCap(c:CGContextRef, cap:CGLineCap) :Void;

/* Set the line join in the current graphics state to `join'. */

	@:nativeImpl @:c public static function CGContextSetLineJoin(c:CGContextRef, join:CGLineJoin) :Void;

/* Set the miter limit in the current graphics state to `limit'. */

	@:nativeImpl @:c public static function CGContextSetMiterLimit(c:CGContextRef, limit:Float) :Void;

/* Set the line dash patttern in the current graphics state of `c'. */

	@:nativeImpl @:c public static function CGContextSetLineDash(c:CGContextRef, phase:Float, lengths:Array<Float>, count:Int) :Void;

/* Set the path flatness parameter in the current graphics state of `c' to
   `flatness'. */

	@:nativeImpl @:c public static function CGContextSetFlatness(c:CGContextRef, flatness:Float) :Void;

/* Set the alpha value in the current graphics state of `c' to `alpha'. */

	@:nativeImpl @:c public static function CGContextSetAlpha(c:CGContextRef, alpha:Float) :Void;

/* Set the blend mode of `context' to `mode'. */

	@:nativeImpl @:c public static function CGContextSetBlendMode(c:CGContextRef, mode:CGBlendMode) :Void;
...
/* Begin a new path. The old path is discarded. */
	...
	@:nativeImpl @:c public static function CGContextBeginPath(c:CGContextRef) :Void;

/* Start a new subpath at point `(x, y)' in the context's path. */

	@:nativeImpl @:c public static function CGContextMoveToPoint(c:CGContextRef, x:Float, y:Float) :Void;

/* Append a straight line segment from the current point to `(x, y)'. */

	@:nativeImpl @:c public static function CGContextAddLineToPoint(c:CGContextRef, x:Float, y:Float) :Void;

/* Append a cubic Bezier curve from the current point to `(x,y)', with
   control points `(cp1x, cp1y)' and `(cp2x, cp2y)'. */

	@:nativeImpl @:c public static function CGContextAddCurveToPoint(c:CGContextRef, cp1x:Float, cp1y:Float, cp2x:Float, cp2y:Float, x:Float, y:Float) :Void;

/* Append a quadratic curve from the current point to `(x, y)', with control
   point `(cpx, cpy)'. */

	@:nativeImpl @:c public static function CGContextAddQuadCurveToPoint(c:CGContextRef, cpx:Float, cpy:Float, x:Float, y:Float) :Void;

/* Close the current subpath of the context's path. */

	@:nativeImpl @:c public static function CGContextClosePath(c:CGContextRef) :Void;

/** Path construction convenience functions. **/

/* Add a single rect to the context's path. */

	@:nativeImpl @:c public static function CGContextAddRect(c:CGContextRef, rect:CGRect) :Void;

/* Add a set of rects to the context's path. */

	@:nativeImpl @:c public static function CGContextAddRects(c:CGContextRef, rects:Array<CGRect>, count:Int) :Void;

/* Add a set of lines to the context's path. */

	@:nativeImpl @:c public static function CGContextAddLines(c:CGContextRef, points:Array<CGRect>, count:Int) :Void;
...
/* Add an ellipse inside `rect' to the current path of `context'. See the
   ...
   for the ellipse is constructed. */
	...
	@:nativeImpl @:c public static function CGContextAddEllipseInRect(c:CGContextRef, rect:CGRect) :Void;
...
/* Add an arc of a circle to the context's path, possibly preceded by a
   ...
   `startAngle' and `endAngle' are measured in radians. */
	...
	@:nativeImpl @:c public static function CGContextAddArc(c:CGContextRef, x:Float, y:Float, radius:Float, startAngle:Float, endAngle:Float, clockwise:Int) :Void;
...
/* Add an arc of a circle to the context's path, possibly preceded by a
   ...
   from `(x1, y1)' to `(x2, y2)'. */
	...
	@:nativeImpl @:c public static function CGContextAddArcToPoint(c:CGContextRef, x1:Float, y1:Float, x2:Float, y2:Float, radius:Float) :Void;

/* Add `path' to the path of context. The points in `path' are transformed
   by the CTM of context before they are added. */

	@:nativeImpl @:c public static function CGContextAddPath(c:CGContextRef, path:CGPathRef) :Void;
...
/* Replace the path in `context' with the stroked version of the path, using
   ...
   followed by a call to "CGContextClip". */
	...
	@:nativeImpl @:c public static function CGContextReplacePathWithStrokedPath(c:CGContextRef) :Void;
...
/* Return true if the path of `context' contains no elements, false
   otherwise. */
	...
	@:nativeImpl @:c public static function CGContextIsPathEmpty(c:CGContextRef) :Bool;

/* Return the current point of the current subpath of the path of
   `context'. */

	@:nativeImpl @:c public static function CGContextGetPathCurrentPoint(c:CGContextRef) :CGPoint;
...
/* Return the bounding box of the path of `context'. The bounding box is the
   ...
   control points for Bezier and quadratic curves. */
	...
	@:nativeImpl @:c public static function CGContextGetPathBoundingBox(c:CGContextRef) :CGRect;

/* Return a copy of the path of `context'. The returned path is specified in
   the current user space of `context'. */

	@:nativeImpl @:c public static function CGContextCopyPath(c:CGContextRef) :CGPathRef;
...
/* Return true if `point' is contained in the current path of `context'. A
   ...
   path drawing mode `mode'. `point' is specified is user space. */
	...
	@:nativeImpl @:c public static function CGContextPathContainsPoint(c:CGContextRef, point:CGPoint, mode:CGPathDrawingMode) :Bool;

/** Path drawing functions. **/

/* Draw the context's path using drawing mode `mode'. */

	@:nativeImpl @:c public static function CGContextDrawPath(c:CGContextRef, mode:CGPathDrawingMode) :Void;
...
/* Fill the context's path using the winding-number fill rule. Any open
   subpath of the path is implicitly closed. */
	...
	@:nativeImpl @:c public static function CGContextFillPath(c:CGContextRef) :Void;

/* Fill the context's path using the even-odd fill rule. Any open subpath of
   the path is implicitly closed. */

	@:nativeImpl @:c public static function CGContextEOFillPath(c:CGContextRef) :Void;

/* Stroke the context's path. */

	@:nativeImpl @:c public static function CGContextStrokePath(c:CGContextRef) :Void;

/* Fill `rect' with the current fill color. */

	@:nativeImpl @:c public static function CGContextFillRect(c:CGContextRef, rect:CGRect) :Void;

/* Fill `rects', an array of `count' CGRects, with the current fill
   color. */

	@:nativeImpl @:c public static function CGContextFillRects(c:CGContextRef, rect:Array<CGRect>, count:Int) :Void;

/* Stroke `rect' with the current stroke color and the current linewidth. */

	@:nativeImpl @:c public static function CGContextStrokeRect(c:CGContextRef, rect:CGRect) :Void;

/* Stroke `rect' with the current stroke color, using `width' as the the
   line width. */

	@:nativeImpl @:c public static function CGContextStrokeRectWithWidth(c:CGContextRef, rect:CGRect, width:Float) :Void;

/* Clear `rect' (that is, set the region within the rect to transparent). */

	@:nativeImpl @:c public static function CGContextClearRect(c:CGContextRef, rect:CGRect) :Void;

/* Fill an ellipse (an oval) inside `rect'. */

	@:nativeImpl @:c public static function CGContextFillEllipseInRect(c:CGContextRef, rect:CGRect) :Void;

/* Stroke an ellipse (an oval) inside `rect'. */

	@:nativeImpl @:c public static function CGContextStrokeEllipseInRect(c:CGContextRef, rect:CGRect) :Void;
...
/* Stroke a sequence of line segments one after another in `context'. The
   ...
   This function is equivalent to
	...
	@:nativeImpl @:c public static function CGContextStrokeLineSegments(c:CGContextRef, points:Array<CGPoint>, count:Int) :Void;
...
/* Intersect the context's path with the current clip path and use the
   ...
   the winding-number fill rule for deciding what's inside the path. */
	...
	@:nativeImpl @:c public static function CGContextClip(c:CGContextRef) :Void;

/* Intersect the context's path with the current clip path and use the
   resulting path as the clip path for subsequent rendering operations. Use
   the even-odd fill rule for deciding what's inside the path. */

	@:nativeImpl @:c public static function CGContextEOClip(c:CGContextRef) :Void;
...
/* Add `mask' transformed to `rect' to the clipping area of `context'. The
   ...
   color. */
	...
	@:nativeImpl @:c public static function CGContextClipToMask(c:CGContextRef, rect:CGRect, mask:CGImageRef) :Void;
...
/* Return the bounding box of the clip path of `c' in user space. The
   ...
   the clip. */
	...
	@:nativeImpl @:c public static function CGContextGetClipBoundingBox(c:CGContextRef) :CGRect;
...
/* Intersect the current clipping path with `rect'. Note that this function
   resets the context's path to the empty path. */
	...
	@:nativeImpl @:c public static function CGContextClipToRect(c:CGContextRef, rect:CGRect) :Void;
...
/* Intersect the current clipping path with the clipping region formed by
   ...
   function resets the context's path to the empty path. */
	...
	@:nativeImpl @:c public static function CGContextClipToRects(c:CGContextRef, rect:Array<CGRect>, count:Int) :Void;

/** Primitive color functions. **/

/* Set the current fill color in the context `c' to `color'. */

	@:nativeImpl @:c public static function CGContextSetFillColorWithColor(c:CGContextRef, color:CGColorRef) :Void;

/* Set the current stroke color in the context `c' to `color'. */

	@:nativeImpl @:c public static function CGContextSetStrokeColorWithColor(c:CGContextRef, color:CGColorRef) :Void;
...
/* Set the current fill color space in `context' to `space'. As a
   ...
   color space. */
	...
	@:nativeImpl @:c public static function CGContextSetFillColorSpace(c:CGContextRef, space:CGColorSpaceRef) :Void;
...
/* Set the current stroke color space in `context' to `space'. As a
   ...
   color space. */
	...
	@:nativeImpl @:c public static function CGContextSetStrokeColorSpace(c:CGContextRef, space:CGColorSpaceRef) :Void;
...
/* Set the components of the current fill color in `context' to the values
   ...
   must not be a pattern color space. */
	...
	@:nativeImpl @:c public static function CGContextSetFillColor(c:CGContextRef, components:Array<Float>) :Void;
...
/* Set the components of the current stroke color in `context' to the values
   ...
   space must not be a pattern color space. */
	...
	@:nativeImpl @:c public static function CGContextSetStrokeColor(c:CGContextRef, components:Array<Float>) :Void;
...
/* Set the components of the current fill color in `context' to the values
   ...
   color space. */
	...
	@:nativeImpl @:c public static function CGContextSetFillPattern(c:CGContextRef, pattern:CGPatternRef, components:Array<Float>) :Void;
...
/* Set the components of the current stroke color in `context' to the values
   ...
   pattern color space. */
	...
	@:nativeImpl @:c public static function CGContextSetStrokePattern(c:CGContextRef, pattern:CGPatternRef, components:Array<Float>) :Void;

/* Set the pattern phase in the current graphics state of `context' to
   `phase'. */

	@:nativeImpl @:c public static function CGContextSetPatternPhase(c:CGContextRef, phase:CGSize) :Void;
...
/* Set the current fill color space in `context' to `DeviceGray' and set the
   components of the current fill color to `(gray, alpha)'. */
	...
	@:nativeImpl @:c public static function CGContextSetGrayFillColor(c:CGContextRef, gray:Float, alpha:Float) :Void;
...
/* Set the current stroke color space in `context' to `DeviceGray' and set
   the components of the current stroke color to `(gray, alpha)'. */
	...
	@:nativeImpl @:c public static function CGContextSetGrayStrokeColor(c:CGContextRef, gray:Float, alpha:Float) :Void;
...
/* Set the current fill color space in `context' to `DeviceRGB' and set the
   components of the current fill color to `(red, green, blue, alpha)'. */
	...
	@:nativeImpl @:c public static function CGContextSetRGBFillColor(c:CGContextRef, red:Float, green:Float, blue:Float, alpha:Float) :Void;
...
/* Set the current stroke color space in `context' to `DeviceRGB' and set
   ...
   alpha)'. */
	...
	@:nativeImpl @:c public static function CGContextSetRGBStrokeColor(c:CGContextRef, red:Float, green:Float, blue:Float, alpha:Float) :Void;
...
/* Set the current fill color space in `context' to `DeviceCMYK' and set the
   ...
   alpha)'. */
	...
	@:nativeImpl @:c public static function CGContextSetCMYKFillColor(c:CGContextRef, cyan:Float, magenta:Float, yellow:Float, black:Float, alpha:Float) :Void;
...
/* Set the current stroke color space in `context' to `DeviceCMYK' and set
   ...
   black, alpha)'. */
	...
	@:nativeImpl @:c public static function CGContextSetCMYKStrokeColor(c:CGContextRef, cyan:Float, magenta:Float, yellow:Float, black:Float, alpha:Float) :Void;
...
/* Set the rendering intent in the current graphics state of `context' to
   `intent'. */
	...
	@:nativeImpl @:c public static function CGContextSetRenderingIntent(c:CGContextRef, intent:CGColorRenderingIntent) :Void;
...
/* Draw `image' in the rectangular area specified by `rect' in the context
   `c'. The image is scaled, if necessary, to fit into `rect'. */
	...
	@:nativeImpl @:c public static function CGContextDrawImage(c:CGContextRef, rect:CGRect, image:CGImageRef) :Void;
...
/* Draw `image' tiled in the context `c'. The image is scaled to the size
   ...
   applied to the CTM affect the final result. */
	...
	@:nativeImpl @:c public static function CGContextDrawTiledImage(c:CGContextRef, rect:CGRect, image:CGImageRef) :Void;
...
/* Return the interpolation quality for image rendering of `context'. The
   ...
   contexts support all interpolation quality levels. */
	...
	@:nativeImpl @:c public static function  CGContextGetInterpolationQuality(context:CGContextRef) :CGInterpolationQuality;

/* Set the interpolation quality of `context' to `quality'. */

	@:nativeImpl @:c public static function CGContextSetInterpolationQuality(c:CGContextRef, quality:CGInterpolationQuality) :Void;
...
/* Set the shadow parameters in `context'. `offset' specifies a translation
   ...
   pass NULL as the color), or use the standard gsave/grestore mechanism. */
	...
	@:nativeImpl @:c public static function CGContextSetShadowWithColor(c:CGContextRef, CGSize offset,
...
/* Equivalent to calling
   ...
   the DeviceRGB color space. */
	...
	@:nativeImpl @:c public static function CGContextSetShadow(c:CGContextRef, CGSize offset,
    Float blur) :Void;
...
/* Fill the current clipping region of `context' with a linear gradient from
   ...
   gradient is drawn before the start point or after the end point. */
	...
	@:nativeImpl @:c public static function CGContextDrawLinearGradient(c:CGContextRef,
...
/* Fill the current clipping region of `context' with a radial gradient
   ...
   gradient is drawn before the start circle or after the end circle. */
	...
	@:nativeImpl @:c public static function CGContextDrawRadialGradient(c:CGContextRef,
...
/* Fill the current clipping region of `context' with `shading'. */
	...
	@:nativeImpl @:c public static function CGContextDrawShading(c:CGContextRef, CGShadingRef shading) :Void;
...
/* Set the current character spacing in `context' to `spacing'. The
   ...
   character and the origin of the next. */
	...
	@:nativeImpl @:c public static function CGContextSetCharacterSpacing(c:CGContextRef, spacing:Float) :Void;

/* Set the user-space point at which text will be drawn in the context `c'
   to `(x, y)'. */

	@:nativeImpl @:c public static function CGContextSetTextPosition(c:CGContextRef, x:Float, y:Float) :Void;

/* Return the user-space point at which text will be drawn in `context'. */

	@:nativeImpl @:c public static function CGPoint CGContextGetTextPosition(c:CGContextRef)
    CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0);

/* Set the text matrix in the context `c' to `t'. */

	@:nativeImpl @:c public static function CGContextSetTextMatrix(c:CGContextRef, CGAffineTransform t) :Void;

/* Return the text matrix in the context `c'. */

	@:nativeImpl @:c public static function CGAffineTransform CGContextGetTextMatrix(c:CGContextRef)
    CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0);

/* Set the text drawing mode in the current graphics state of the context
   `c' to `mode'. */

	@:nativeImpl @:c public static function CGContextSetTextDrawingMode(c:CGContextRef,
    CGTextDrawingMode mode) :Void;

/* Set the font in the current graphics state of the context `c' to
   `font'. */

	@:nativeImpl @:c public static function CGContextSetFont(c:CGContextRef, CGFontRef font) :Void;

/* Set the font size in the current graphics state of the context `c' to
   `size'. */

	@:nativeImpl @:c public static function CGContextSetFontSize(c:CGContextRef, Float size) :Void;
...
/* Attempts to find the font named `name' and, if successful, sets it as the
   ...
   translate from bytes to glyphs when displaying text. */
	...
	@:nativeImpl @:c public static function CGContextSelectFont(c:CGContextRef, const char *name,
...
/* Draw `glyphs', an array of `count' CGGlyphs, at the points specified by
   ...
   associated glyph; the positions are specified in user space. */
	...
	@:nativeImpl @:c public static function CGContextShowGlyphsAtPositions(c:CGContextRef,
...
/* Draw `string', a string of `length' bytes, at the point specified by the
   ...
   display. */
	...
	@:nativeImpl @:c public static function CGContextShowText(c:CGContextRef, const char *string,
    size_t length) :Void;
...
/* Draw `string', a string of `length' bytes, at the point `(x, y)',
   ...
   glyph to display. */
	...
	@:nativeImpl @:c public static function CGContextShowTextAtPoint(c:CGContextRef, x:Float, y:Float,
...
/* Draw the glyphs pointed to by `g', an array of `count' glyphs, at the
   point specified by the text matrix in the context `c'. */
	...
	@:nativeImpl @:c public static function CGContextShowGlyphs(c:CGContextRef, const CGGlyph g[],
    size_t count) :Void;

/* Display the glyphs pointed to by `glyphs', an array of `count' glyphs, at
   the point `(x, y)', specified in user space, in `context'. */

	@:nativeImpl @:c public static function CGContextShowGlyphsAtPoint(c:CGContextRef, x:Float,
...
/* Draw `glyphs', an array of `count' CGGlyphs, at the current point
   ...
   glyph; the advances are specified in user space. */
	...
	@:nativeImpl @:c public static function CGContextShowGlyphsWithAdvances(c:CGContextRef,
...
/* Draw `page' in the current user space of the context `c'. */
	...
	@:nativeImpl @:c public static function CGContextDrawPDFPage(c:CGContextRef, CGPDFPageRef page) :Void;

/** Output page functions. **/

/* Begin a new page. */

	@:nativeImpl @:c public static function CGContextBeginPage(c:CGContextRef, const CGRect *mediaBox) :Void;

/* End the current page. */

	@:nativeImpl @:c public static function CGContextEndPage(c:CGContextRef) :Void;

/** Context functions. **/

/* Equivalent to `CFRetain(c)'. */

	@:nativeImpl @:c public static function CGContextRef CGContextRetain(c:CGContextRef)
    CG_AVAILABLE_STARTING(__MAC_10_0, __IPHONE_2_0);

/* Equivalent to `CFRelease(c)'. */

	@:nativeImpl @:c public static function CGContextRelease(c:CGContextRef) :Void;

/* Flush all drawing to the destination. */

	@:nativeImpl @:c public static function CGContextFlush(c:CGContextRef) :Void;

/* Synchronized drawing. */

	@:nativeImpl @:c public static function CGContextSynchronize(c:CGContextRef) :Void;
...
/* Turn on antialiasing if `shouldAntialias' is true; turn it off otherwise.
   This parameter is part of the graphics state. */
	...
	@:nativeImpl @:c public static function CGContextSetShouldAntialias(c:CGContextRef, shouldAntialias:Bool) :Void;
...
/* Allow antialiasing in `context' if `allowsAntialiasing' is true; don't
   ...
   graphics state parameter `shouldAntialias' are true. */
	...
	@:nativeImpl @:c public static function CGContextSetAllowsAntialiasing(c:CGContextRef,
    allowsAntialiasing:Bool) :Void;
...
/* Turn on font smoothing if `shouldSmoothFonts' is true; turn it off
   ...
   contexts support font smoothing. */
	...
	@:nativeImpl @:c public static function CGContextSetShouldSmoothFonts(c:CGContextRef,
    shouldSmoothFonts:Bool) :Void;
...
/* If `allowsFontSmoothing' is true, then allow font smoothing when
   ...
   graphics state parameter `shouldSmoothFonts' are true. */
	...
	@:nativeImpl @:c public static function CGContextSetAllowsFontSmoothing(c:CGContextRef,
    allowsFontSmoothing:Bool) :Void;
...
/* If `shouldSubpixelPositionFonts' is true, then glyphs may be placed at
   ...
   parameter is part of the graphics state. */
	...
	@:nativeImpl @:c public static function CGContextSetShouldSubpixelPositionFonts(c:CGContextRef,
    shouldSubpixelPositionFonts:Bool) :Void;
...
/* If `allowsFontSubpixelPositioning' is true, then allow font subpixel
   ...
   the graphics state parameter `shouldSubpixelPositionFonts' are true. */
	...
	@:nativeImpl @:c public static function CGContextSetAllowsFontSubpixelPositioning(c:CGContextRef,
    allowsFontSubpixelPositioning:Bool) :Void;
...
/* If `shouldSubpixelQuantizeFonts' is true, then quantize the subpixel
   ...
   state. */
	...
	@:nativeImpl @:c public static function CGContextSetShouldSubpixelQuantizeFonts(c:CGContextRef,
    shouldSubpixelQuantizeFonts:Bool) :Void;
...
/* If `allowsFontSubpixelQuantization' is true, then allow font subpixel
   ...
   state parameter `shouldSubpixelQuantizeFonts' are both true. */
	...
	@:nativeImpl @:c public static function CGContextSetAllowsFontSubpixelQuantization(c:CGContextRef,
    allowsFontSubpixelQuantization:Bool) :Void;
...
/* Begin a transparency layer in `context'. All subsequent drawing
   ...
   Transparency layers may be nested. */
	...
	@:nativeImpl @:c public static function CGContextBeginTransparencyLayer(c:CGContextRef,
    auxiliaryInfo:CFDictionaryRef) :Void;
...
/* Begin a transparency layer in `context'. This function is identical to
  ...
  transparency layer will be bounded by `rect' (specified in user space). */
	...
	@:nativeImpl @:c public static function CGContextBeginTransparencyLayerWithRect(c:CGContextRef,
    rect:CGRect,auxiliaryInfo: CFDictionaryRef) :Void;

/* End a tranparency layer. */

	@:nativeImpl @:c public static function CGContextEndTransparencyLayer(c:CGContextRef) :Void;
...
/* Return the affine transform mapping the user space (abstract coordinates)
   of `context' to device space (pixels). */
	...
	@:nativeImpl @:c public static function
    CGContextGetUserSpaceToDeviceSpaceTransform(c:CGContextRef):CGAffineTransform;
    //CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_2_0);

/* Transform `point' from the user space of `context' to device space. */

	@:nativeImpl @:c public static function CGContextConvertPointToDeviceSpace(c:CGContextRef,
    point:CGPoint):CGPoint;// CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_2_0);

/* Transform `point' from device space to the user space of `context'. */

	@:nativeImpl @:c public static function CGContextConvertPointToUserSpace(c:CGContextRef,
    CGPoint point):CGPoint;// CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_2_0);

/* Transform `size' from the user space of `context' to device space. */

	@:nativeImpl @:c public static function CGContextConvertSizeToDeviceSpace(c:CGContextRef,
    size:CGSize):CGSize CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_2_0);

/* Transform `size' from device space to the user space of `context'. */

	@:nativeImpl @:c public static function CGContextConvertSizeToUserSpace(c:CGContextRef,
    size:CGSize):CGSize;// CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_2_0);
...
/* Transform `rect' from the user space of `context' to device space. Since
   ...
   points of `rect'. */
	...
	@:nativeImpl @:c public static function CGContextConvertRectToDeviceSpace(c:CGContextRef,
    rect:CGRect):CGRect;// CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_2_0);
...
/* Transform `rect' from device space to the user space of `context'. Since
   ...
   points of `rect'. */
	...
	@:nativeImpl @:c public static function CGContextConvertRectToUserSpace(c:CGContextRef,
    rect:CGRect):CGRect;// CG_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_2_0);
